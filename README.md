...
├── report/
│   └── Project_Report_Tanmay_Tiwari.pdf       # Final 1000-word comprehensive report
├── task-1-presentation/
│   └── digital_literacy_infographic.png       # Canva Infographic on AI & Literacy
├── task-2-portfolio/
│   ├── github_profile.png                     # Screenshot of GitHub Profile
│   ├── linkedin_profile.png                   # Screenshot of LinkedIn Profile
│   └── researchgate_profile.png               # Screenshot of ResearchGate Profile
├── task-3-platforms/
│   ├── hackerrank_proof.png                   # Python 2-Star & Problem Solving Badge
│   ├── google_form_editor.png                 # Screenshot of Quiz Questions
│   └── google_sheets_responses.png            # Screenshot of linked Response Sheet
├── task-4-email-etiquette/
│   ├── professional_email_drafts.pdf          # HOD Meeting & Faculty LOR Emails
│   └── social_media_checklist.pdf             # 7-Point Professionalism Checklist
├── task-5-cybercrime/
│   └── cybercrime_case_study_prevention.pdf   # Phishing Case Study & 6-Point Prevention
...
Communicate professionally with academic leadership via Email Etiquette.
